...
<body>
  ...
  <div align="center" style="padding: 70px;">
    <table>
        <tr style="background-color: rgb(46, 201, 154);">
            <th style="padding: 10px; font-size:20px; color:white;">Doctor name</th>
            <th style="padding: 10px; font-size:20px; color:white;">Date</th>
            <th style="padding: 10px; font-size:20px; color:white;">Message</th>
            <th style="padding: 10px; font-size:20px; color:white;">Status</th>
            <th style="padding: 10px; font-size:20px; color:rgb(255, 255, 255);">Action</th>
        </tr>
        @if ($appoint->isEmpty())
          <tr><td colspan="5">No appointments available.</td></tr>
        @else
          @foreach ($appoint as $appoints)
            <tr style="background-color: rgb(3, 19, 13)" align="center">
